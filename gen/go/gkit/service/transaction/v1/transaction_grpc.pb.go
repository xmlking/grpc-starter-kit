...
func (c *transactionServiceClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gkit.service.transaction.v1.TransactionService/Read", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionServiceClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/gkit.service.transaction.v1.TransactionService/Write", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTransactionServiceServer) Write(context.Context, *WriteRequest) (*emptypb.Empty, error) {
...
func _TransactionService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gkit.service.transaction.v1.TransactionService/Read",
	}
...
func _TransactionService_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gkit.service.transaction.v1.TransactionService/Write",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gkit.service.transaction.v1.TransactionService",
	...
	Metadata: "gkit/service/transaction/v1/transaction.proto",
}
