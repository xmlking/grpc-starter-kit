...
func (c *profileServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gkit.service.account.profile.v1.ProfileService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/gkit.service.account.profile.v1.ProfileService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gkit.service.account.profile.v1.ProfileService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProfileService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gkit.service.account.profile.v1.ProfileService/List",
	}
...
func _ProfileService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gkit.service.account.profile.v1.ProfileService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProfileService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gkit.service.account.profile.v1.ProfileService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gkit.service.account.profile.v1.ProfileService",
	...
	Metadata: "gkit/service/account/profile/v1/profile_service.proto",
}
