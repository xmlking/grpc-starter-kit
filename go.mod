...
require (
	...
	github.com/xiaoqidun/entps v0.0.0-20220405071449-20888c44a32a
	github.com/xmlking/toolkit v0.2.6
	github.com/xmlking/toolkit/broker/cloudevents v0.2.6
	github.com/xmlking/toolkit/confy v0.2.6
